...
<template>
  ...
  <div class="tree-container">
    ...
    <br>
    <LeafRow title="2019.10 ~ 2020.6" sentence="大手SIerにてシステム開発に従事" substance="ログ分析ツールの改修・対話型サービスにおけるアプリケーション開発" language="[使用言語] Node.js" framework="[フレームワーク] Express" versioncontrol="[バージョン管理] Git" other="[その他] Docker, ElasticSearch, Kibana, ansible"></LeafRow>
    <br>
    <LeafRow title="2020.9 ~ " sentence="株式会社エラン入社 aaaa" ></LeafRow>
    <br>
